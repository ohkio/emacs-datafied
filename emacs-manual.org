...
** Help
   ...
   - ~C-h a /topics/ <RET>~ :: This is an apropos command, literally
     ...
     the argument /topics/
   - ~C-h i d m emacs <RET> i /topic/ <RET>~ :: This navigates to the
     Emacs manual and then searches for /topic/ in the indices.
   - ~C-h i d m emacs <RET> s /topic/ <RET>~ :: Similar as above, but
...
* Command
** The Organization of the Screen
*** what-cursor-position                                        :inform:char:
    :PROPERTIES:
    :Command:  C-x =
...
*** delete-backward-char                                   :edit:char:delete:
    :PROPERTIES:
    :Command:  <DEL>
    :Description: Delete character after point
    :Context:  editing
    :END:
...
*** column-number-mode                                     :inform:line:mode:
    ...
    :Context:  editing
    :END:
*** count-words-region                                        :inform:region:
    :PROPERTIES:
    :Command:  M-=
    :Description: Display the number of lines, words, chars in region
    :Context:  editing
    :END:
*** count-words                                        :inform:buffer:region:
    :PROPERTIES:
    :Command:  C-u M-=
    :Description: Display number of lines, words, and characters in buffer or region
    :Context:  editing
    :END:
*** what-cursor-position                            :inform:char:buffer:line:
    :PROPERTIES:
    :Command:  C-x =
...
*** repeat                                                             :keys:
    ...
    :END:
** The Minibuffer
*** minibuffer-electric-default-mode                         :buffer:display:
    :PROPERTIES:
    :Description: Toggle Minibuffer Electric Default mode
    :Context:  anywhere
    :END:
*** file-name-shadow-mode                                    :buffer:display:
    :PROPERTIES:
    :Description: Toggle File Name Shadow mode
    :Context:  anywhere
    :END:
*** minibuffer-complete                                      :buffer:command:
    :PROPERTIES:
    :Command:  <TAB>
...
*** minibuffer-complete-word                                 :buffer:command:
    :PROPERTIES:
    :Command:  <SPC>
...
*** previous-line-or-history-element                   :buffer:line:nav:hist:
    :PROPERTIES:
    :Command:  <UP>
    :Description: Move previous line if exists, else previous minibuffer item
    :Context:  minibuffer
    :END:
*** next-line-or-history-element                       :buffer:line:nav:hist:
    :PROPERTIES:
    :Command:  <DOWN>
    :Description: Move next line if exists, else move next minibuffer item
    :Context:  minibuffer
    :END:
*** previous-matching-history-element                      :buffer:line:hist:
    :PROPERTIES:
    :Command:  M-r
    ...
    entry.
*** next-matching-history-element                          :buffer:line:hist:
    :PROPERTIES:
    :Command:  M-s
    ...
    A numeric prefix argument /n/ means to fetch the /n/-th matching
    entry.
*** repeat-complex-command                              :command:buffer:hist:
    :PROPERTIES:
    :Command:  C-x <ESC> <ESC>
...
*** Yes No Quit                                                :undo:command:
    ...
    :END:
** Running Commands by Name
*** execute-extended-command                                 :command:buffer:
    :PROPERTIES:
    :Command:  M-x
...
*** push-button                                               :helps:command:
    ...
    :Context:  help
    :END:
*** apropos-command                                    :command:helps:window:
    :PROPERTIES:
    :Command:  C-h a
...
*** insert-default-directory                                 :buffer:display:
    ...
    directory.
*** resize-mini-windows                                      :buffer:display:
...
*** max-mini-window-height                                   :buffer:display:
...
*** enable-recursive-minibuffers                             :buffer:command:
...
*** confirm-nonexistent-file-or-buffer                       :buffer:command:
...
*** completion-styles                                         :list:complete:
    ...
    [[How Completion Alternatives Are Chosen]]
*** read-file-name-completion-ignore-case                    :files:complete:
...
*** completion-auto-help                              :complete:inform:helps:
...
*** completion-cycle-threshold                        :complete:inform:helps:
