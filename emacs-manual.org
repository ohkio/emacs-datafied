...
*** Text Faces
    ...
    font, height, weignt, slant, foreground and background color, and
    ...
    by Font Lock mode.
*** Colors for Faces
    Faces can have farious foreground and background colors. When you
    ...
    componnent's relative intensity, one to four digits long (usually
...
*** Font Lock mode
    ...
    Comment and string fontification (or "syntatic" fontification)
    ...
    on a special convention: an open-parenthesis or open-prace in the
...
*** Displaying Boundaries
    ...
    ~prog-moce~ to indicate the position of a specific column.
*** Useless Whitespace
* Vocabulary
** Basics
*** Frame
...
*** text-scale-adjust                                               :display:
    ...
    :Description: Adjust the hight of the default face
    :Context:  anywhere
    :Argument: numeric
    :END:
...
*** highlight-lines-matching-regexp              :display:buffer:line:search:
    :PROPERTIES:
    :Command:  M-s h l
    :Description: Hi-lght lines with match for given regexp using given face
    :Context:  navigating
    :END:
...
*** delete-trailing-lines                               :edit:command:buffer:
    Normally when using the command ~delte-trailing-whitespace~ the
...
**** header-line-highlight
     ...
     mous sensitive portions of text on header lines. This is a
...
**** fringe
     ...
     borders.)
**** cursor
     The ~:background~ aattribute of this face specifies the color of
     the text cursor.
**** tooltip
